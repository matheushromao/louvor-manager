...
<div class="mx-auto max-w-3xl">
    <div class="rounded-[2rem] bg-white p-8 shadow-[0_20px_80px_rgba(15,23,42,0.12)] card-panel">
        <div class="mb-8">
            <h1 class="text-3xl font-semibold text-slate-900">Criar novo usuário</h1>
            <p class="mt-2 text-sm text-slate-600">Adicione um usuário com role e senha para acessar o sistema.</p>
        </div>
        ...
        <form action="{{ route('users.store') }}" method="POST" class="space-y-6">
            ...
            <div class="flex flex-wrap items-center gap-3 pt-2">
                <button type="submit" class="btn-primary inline-flex items-center justify-center rounded-full px-6 py-3 text-sm font-semibold shadow-lg shadow-slate-900/10">Salvar usuário</button>
