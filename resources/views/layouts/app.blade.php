        ...
        <div class="flex-1 overflow-y-auto">
            ...
            <nav class="space-y-1 p-4">
                ...
                <a
                    ...
                    class="{{ $linkBase }} {{ request()->routeIs('settings.edit', 'settings.update') ? $linkActive : $linkIdle }}">
                    <svg class="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.6" stroke="currentColor">
                ...
                <a
                    href="{{ route('settings.smtp.edit') }}"
                    class="{{ $linkBase }} {{ request()->routeIs('settings.smtp.*') ? $linkActive : $linkIdle }}">
                    <svg class="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.6" stroke="currentColor">
